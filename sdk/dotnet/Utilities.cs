...
namespace Pulumi.DiscordBot
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.DiscordBot.version.txt");
    ...
    internal sealed class DiscordBotResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public DiscordBotResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
